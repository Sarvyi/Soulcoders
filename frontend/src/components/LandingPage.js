...
<div className="py-12">
  <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div className="text-center bg-white p-6 max-w-sm mx-auto rounded-lg shadow-md">
      ...
      <p>Monitor hydraulic systems in real-time to detect issues before they escalate.</p>
    </div>
    {/* Feature 2 */}
    <div className="text-center bg-white p-6 max-w-sm mx-auto rounded-lg shadow-md">
...
<div className="py-6 bg-gray-100">
  <div className="max-w-4xl mx-auto">
    ...
    <p>
      By harnessing the power of AI and predictive modeling, our app analyzes data from your hydraulic systems to forecast potential issues, ensuring that maintenance can be conducted just in time to prevent failures. This proactive approach guarantees the longevity of your equipment and minimizes downtime.
    </p>
  </div>
</div>
